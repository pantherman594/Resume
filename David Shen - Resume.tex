...
\begin{minipage}[t]{0.7\textwidth}
  ...
  \begin{itemize}
    \item Took ownership of a project bringing a highly desired---by internal Windows teams and external clients---feature to Windows containers that decreased specific application loading scenarios from minutes to seconds.
  \end{itemize}
  ...
  \textbf{rSpace} \, \textit{\color{gray}{Student Run Startup}} \hfill \textit{Atlanta, GA} \textbf{Remote} \newline
